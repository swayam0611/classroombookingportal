# COEP Room Scheduler & Classroom Portal
### A Full-Stack Classroom Management System for COEP Technological University

---

## 📌 Project Overview
The **COEP Room Scheduler** is a web-based application designed to streamline the process of booking lecture halls and labs across various departments at COEP. The system provides a real-time, interactive interface for students and faculty to check room availability and manage academic schedules efficiently.
...
* **Session-based Authentication:** Secure Login/Logout flow to protect internal university data.

---

## 🏗️ Object-Oriented Design (OO Principles)
